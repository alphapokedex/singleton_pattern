...
mixin Components {
  /// Scrollable physics to prevent scrolling
  ...
  /// Common use minor components for UX
  ...
  Widget get dialogLoader => Center(
        key: NavigationService.loaderValueKey,
        child: Container(
          height: 50,
          width: 50,
          padding: all20,
  ...
  /// Commonly used durations for animation, transition etc
  ...
  /// Commonly used padding and margin [EdgeInsets] constants
  ...
  /// Commonly used radius & border radius
  ...
  /// Commonly used height [SizedBox] widgets
  ...
  /// Commonly used width [SizedBox] widgets
